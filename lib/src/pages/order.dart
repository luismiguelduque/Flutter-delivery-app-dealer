                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Column(
                                          ...
                                          children: <Widget>[
                                            Helper.getPrice(_con.total, context, style: Theme.of(context).textTheme.headline4),
                                            Text(
...
//                                            arguments: new RouteArgument(param: _con.order.deliveryAddress));
                            ...
                            ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return OrderItemWidget(heroTag: 'my_orders', order: _con.order, foodOrder: _con.order.foodOrders.elementAt(index));
                              },
                            ),
                          ],
                        ),
                    ...
                    Positioned(
                      bottom: 0,
                      child: Container(
                        height: _con.order.orderStatus.id == '5' ? 215 : 270,
