...
Future<void> updateLocation(String latitude, String longitude) async {
  ...
  Map<String, String> custom_fields = new Map();
  custom_fields['phone'] = null;
  custom_fields['bio'] = null;
  custom_fields['address'] = null;
  custom_fields['cur_latitude'] = latitude;
  custom_fields['cur_longitude'] = longitude;
