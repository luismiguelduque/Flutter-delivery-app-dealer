...
class MapController extends ControllerMVC {
  ...
  void getRestaurantsOfArea() async {
    setState(() {
      ...
      LocationData areaLocation = LocationData.fromMap({"latitude": cameraPosition.target.latitude, "longitude": cameraPosition.target.longitude});
  ...
  void getDirectionSteps() async {
    ...
    mapsUtil
      ...
      setState(() {
        polylines.add(
            new Polyline(visible: true, polylineId: new PolylineId(currentLocation.hashCode.toString()), points: _latLng, color: Color(0xFFea5c44), width: 6));
      });
    });
  }
